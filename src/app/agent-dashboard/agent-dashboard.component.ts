...
//   private pusher: Pusher; // Type is now directly from the default import
...
export class AgentDashboardComponent implements OnInit {
  ...
  private apiUrl = 'https://xavier-back.onrender.com'; // API URL
  ...
  constructor(
    ...
    this.pusher = new Pusher(this.pusherKey, {
      ...
      // encrypted: true // Uncomment if you need encryption
    });
  }
